(async function() {
        ...
        createElement("div", ["splus-permissions-box"], {}, [
            ...
            createElement("div", ["splus-permissions-header"], {}, [
                ...
                createElement("p", ["splus-permissions-description"], {}, [
                    createElement("span", [], {
                        textContent: "Due to a new security feature, Schoology Plus needs access to your Schoology API Key for the following features to work correctly:"
                    }),
                    createElement("div", ["splus-permissions-section"], {}, [
                        createElement("ul", ["splus-permissions-features-list"], {}, [
                            createElement("li", [], {
                                textContent: "What-If Grades"
                            }),
                            createElement("li", [], {
                                textContent: "Assignment Checkmarks"
                            }),
                            createElement("li", [], {
                    ...
                    createElement("span", [], {
                        textContent: "By providing access to your API key, Schoology Plus can view extra details about the courses you're enrolled in."
                    }),
                    createElement("div", ["splus-permissions-section"], {}, [
                    ...
                    createElement("div", ["splus-permissions-section"], {}, [
                        ...
                        createElement("span", [], {
                            textContent: ". You can change this setting at any time in the Schoology Plus settings menu."
                        }),
                    ])
                ]),
            ]),
    ...
    if (submitButton === null) {
        ...
        permElement.append(
            createElement("div", ["splus-permissions-section"], {
                ...
                createElement("span", [], {
                    textContent: "It looks like your school or district has disabled API Key generation. Unfortunately, this means the above features will not work. The rest of Schoology Plus' features will still work, though!"
                }),
                createElement("div", ["splus-permissions-section"], {}, [
        ...
        if (window.splus.Setting.getValue("apistatus") !== "allowed" && window.splus.Setting.getValue("apistatus") !== "blocked") {
            ...
            window.splus.Setting.setValue("apistatus", "blocked");
        }
    ...
    submitButton.parentElement.insertAdjacentElement("afterend", createElement("div", ["splus-api-key-footer"], {
        style: {
            textAlign: "center"
        }
    }, [
        createElement("a", [], {
            ...
            onclick: () => {
                ...
                window.splus.Setting.setValue("apiuser", getUserId(), () => {
                    window.splus.Setting.setValue("apistatus", "denied", () => {
                        location.pathname = "/";
                    });
                });
            }
