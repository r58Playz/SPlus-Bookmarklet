(async function() {
    ...
    for (let course of document.querySelectorAll("li.course-item.list-item")) {
        ...
        course.prepend(createElement("img", ["course-list-icon"], {
            src: Theme.getIcon(course.querySelector(".course-title").textContent) || chrome.runtime.getURL("imgs/fallback-course-icon.svg")
        }));
